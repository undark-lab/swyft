...
class SwyftDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None):
        hook = None if self.simulator is None else self.simulator.noise
...
class SwyftModule(pl.LightningModule):
    def __init__(self, cfg):
        ...
        self.lr = cfg.estimation.optimizer.lr
        self._predict_condition_x = {}
        self._predict_condition_z = {}
        #self.lr = lr
        
    def on_train_start(self):
        self.logger.log_hyperparams(self.cfg, {"hp/KL-div": -1, "hp/JS-div": -1})
    ...
    def configure_optimizers(self):
        optimizer = hydra.utils.instantiate(self.cfg.estimation.optimizer, self.parameters(), lr=self.lr)
