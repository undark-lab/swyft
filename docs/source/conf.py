...
sys.path.insert(1, os.path.abspath("../../swyft"))
...
version = u".".join(__version_tuple__[:2])
...
man_pages = [(master_doc, "swyft", u"swyft Documentation", [author], 1)]
